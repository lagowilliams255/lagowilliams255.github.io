...
/** @type {string} */
const OFFLINE_URL = 'Loogie Bridge.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Loogie Bridge.html","Loogie Bridge.js","Loogie Bridge.offline.html","Loogie Bridge.icon.png","Loogie Bridge.apple-touch-icon.png","Loogie Bridge.audio.worklet.js","Loogie Bridge.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Loogie Bridge.wasm","Loogie Bridge.pck"];
