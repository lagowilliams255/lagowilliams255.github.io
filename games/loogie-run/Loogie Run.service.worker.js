...
/** @type {string} */
const CACHE_VERSION = '1779929386|862036378';
/** @type {string} */
const CACHE_PREFIX = 'Loogie Run-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Loogie Run.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Loogie Run.html","Loogie Run.js","Loogie Run.offline.html","Loogie Run.icon.png","Loogie Run.apple-touch-icon.png","Loogie Run.audio.worklet.js","Loogie Run.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Loogie Run.wasm","Loogie Run.pck"];
