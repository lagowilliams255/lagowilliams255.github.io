...
/** @type {string} */
const OFFLINE_URL = 'Loogie Jump.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Loogie Jump.html","Loogie Jump.js","Loogie Jump.offline.html","Loogie Jump.icon.png","Loogie Jump.apple-touch-icon.png","Loogie Jump.audio.worklet.js","Loogie Jump.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Loogie Jump.wasm","Loogie Jump.pck"];
